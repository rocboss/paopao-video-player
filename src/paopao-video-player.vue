...
export default defineComponent({
  name: 'PaoPaoVideoPlayer', // vue component name
...
<template>
  <div class="paopao-video-player">
    <component :is="theme" :uuid="uuid" :src="src" :autoplay="autoplay" :loop="loop" :controls="controls" :mask="mask"
      :colors="colors" :time="time" :playing="playing" :duration="duration" :hoverable="hoverable" @play="play"
      @stop="stop" @timeupdate="({ currentTime }) => time.current = currentTime" @position="position"
      @fullScreen="fullScreen" @setPlayer="setPlayer" @isPlaying="isPlaying" />
